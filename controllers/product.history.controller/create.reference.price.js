    ...
    ProductHistory.find({
      ...
      if (!value) {
        ...
        if (findDate.length < 9) {
          res.send({
            status: true,
            reference: `P${dayjs(Date.now()).format("YYYYMM")}0000${
              findDate.length + 1
            }`,
          });
          ...
          res.send({
            status: true,
            reference: `P${dayjs(Date.now()).format("YYYYMM")}000${
              findDate.length + 1
            }`,
          });
          ...
          res.send({
            status: true,
            reference: `P${dayjs(Date.now()).format("YYYYMM")}00${
              findDate.length + 1
            }`,
          });
          ...
          res.send({
            status: true,
            reference: `P${dayjs(Date.now()).format("YYYYMM")}0${
              findDate.length + 1
            }`,
          });
          ...
          res.send({
            status: true,
            reference: `P${dayjs(Date.now()).format("YYYYMM")}${
              findDate.length + 1
            }`,
          });
        }
